...
public class BookingController {
    ...
    // ✅ NEW: Return today's booking counts per restaurant
    @GetMapping("/count/today")
    public ResponseEntity<Map<Long, Long>> getTodayBookingCounts() {
        LocalDate today = LocalDate.now();
        Map<Long, Long> counts = bookingService.getTodayBookingCounts(today);
